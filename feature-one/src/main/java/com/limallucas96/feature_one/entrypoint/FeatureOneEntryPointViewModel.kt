...
class FeatureOneEntryPointViewModel : BaseMVIViewModel<FeatureOneEntryPointEvents, FeatureOneEntryPointViewState, FeatureOneEntryPointSideEffects>() {

    override fun createInitialViewState() = FeatureOneEntryPointViewState()

    override fun handleEvent(event: FeatureOneEntryPointEvents) {
       when (event) {
